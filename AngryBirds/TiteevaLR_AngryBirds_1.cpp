...
// ĺńëč ńâčíîę ěíîăî, óěĺíüřčňü ęîëč÷ĺńňâî if
...
// îńňŕíîâčňü čăđó. čń÷ĺçíîâĺíčĺ ńâčíęč, ń ęîňîđîé ńňîëęíóëŕńü ďňč÷ęŕ
...
void PhysicsBird (double* x, double* y, double* vx, double* vy, int* ay, int dt, double Size)
    ...
    *vx = (*vx) * 0.99;  // óěĺíüřĺíčĺ ďî 0X âńĺăäŕ çŕ ń÷ĺň ńîďđîňčâëĺíč˙ âîçäóőŕ
    *vy = (*vy) * 0.99;  // óěĺíüřĺíčĺ ďî 0Y
    // ďđč ďîëĺňĺ ââĺđő çŕěĺäë˙ţůŕ˙ ńîńňŕâë˙ţůŕ˙: ay + a(ńîďđîňčâëĺíč˙ âîçäóőŕ)
    // ďđč ďîëĺňĺ âíčç óńęîđ˙ţůŕ˙ ńîńňŕâë˙ţůŕ˙: ay - a(ńîďđîňčâëĺíč˙ âîçäóőŕ)
...
// Äîëćíű ńňî˙ňü íŕ ěĺńňĺ äî ńňîëęíîâĺíč˙
void PhysicsPig (double* x, double* y, double* vx, double* vy, int* ay, int dt, double Size)
    {
    *vy += *ay * dt;
